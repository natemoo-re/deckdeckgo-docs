...
<h3 id="usage-with-file-uri">Usage with file URI</h3>
<deckgo-highlight-code language="javascript">
    ...
    </deckgo-highlight-code><h3 id="usage-with-slotted-element">Usage with slotted element</h3>
<deckgo-highlight-code language="javascript">
...
<h3 id="example-with-file-uri">Example with file URI</h3>
<deckgo-highlight-code language="javascript">
    ...
    </deckgo-highlight-code><h3 id="example-with-slotted-element">Example with slotted element</h3>
<deckgo-highlight-code language="javascript">
