...
<p><a href="https://deckdeckgo.com">DeckDeckGo</a> is a deck of slides where each slide has its own layout and behaviour respectively their template. Their content could be edited and structured using <code>slots</code> and other attributes.</p>
...
<deckgo-highlight-code language="javascript">
    ...
    </deckgo-highlight-code><p>In the previous example, the first slide use the template <code>deckgo-slide-title</code> and the second slide use the template <code>deckgo-slide-content</code>.</p>
