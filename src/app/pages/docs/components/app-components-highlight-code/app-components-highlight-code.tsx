...
<deckgo-highlight-code language="javascript">
    ...
    </deckgo-highlight-code><h3 id="install-deckdeckgo-highlight-code-from-npm">Install DeckDeckGo Highlight Code from NPM</h3>
...
<h4 id="find-the-next-anchor">Find the next anchor</h4>
<deckgo-highlight-code language="javascript">
      <code slot="code">findNextAnchor(enter: boolean) =&gt; Promise&lt;boolean&gt;</code>
    </deckgo-highlight-code><h4 id="zoom-into-code">Zoom into code</h4>
<deckgo-highlight-code language="javascript">
