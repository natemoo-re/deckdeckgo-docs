...
<p>The <a href="https://deckdeckgo.com">DeckDeckGo</a> deck expose a couple of extra features which could be added to your presentation too if you don&#39;t already use the starter kit.</p>
...
<h3 id="app-deck-extra-features-toggle-onoff-the-full-screen-mode">Toggle on/off the full screen mode</h3>
<deckgo-highlight-code language="javascript">
      <code slot="code">await deck.toggleFullScreen();</code>
    </deckgo-highlight-code><h3 id="app-deck-extra-features-print-the-presentation">Print the presentation</h3>
<deckgo-highlight-code language="javascript">
      <code slot="code">await deck.print();</code>
    </deckgo-highlight-code><h3 id="app-deck-extra-features-mobile">Mobile</h3>
